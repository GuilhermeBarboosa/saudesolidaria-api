...
public class SwaggerConfiguration {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.edu.iftm"))
                .build()
                .apiInfo(getApiInfo())
    ...
    private ApiInfo getApiInfo() {
        return new ApiInfoBuilder()
                .title("Saude Soldiaria API")
                .description("API para Saude Soldiaria")
                .contact(new Contact("Guilherme", "", "guilherme.rocha@estudante.iftm.edu.br"))
                .version("1.0.0")
                .build();
    }
